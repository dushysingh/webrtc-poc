...
// Last time updated: 2020-09-07 PM UTC
...
var RTCMultiConnection = function(roomid, forceOptions) {
    ...
    (function(connection) {
        ...
        connection.waitingForLocalMedia = false;
        connection.customUserMedia = window.currentUserMediaRequest
        connection.open = function(roomid, callback) {
            var customUserMedia = window.currentUserMediaRequest
        ...
        connection.invokeGetUserMedia = function(localMediaConstraints, callback, session) {
            ...
            var customUserMedia = currentUserMediaRequest;
            getUserMediaHandler({
